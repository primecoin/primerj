...
public class MnemonicCodeTest {
    ...
    String vectors[] = {"00000000000000000000000000000000", "abandon abandon abandon abandon " +
            "abandon abandon abandon abandon abandon abandon abandon about",
            "c55257c360c07c72029aebc1b53c05ed0362ada38ead3e3e9efa3708e53495531f09a6987599d18264c1e1c92f2cf141630c7a3c4ab7c81b2f001698e7463b04",

            "7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f", "legal winner thank year wave sausage worth " +
            "useful legal winner thank yellow",
            "2e8905819b8723fe2c1d161860e5ee1830318dbf49a83bd451cfb8440c28bd6fa457fe1296106559a3c80937a1c1069be3a3a5bd381ee6260e8d9739fce1f607",


            "80808080808080808080808080808080", "letter advice cage absurd amount doctor acoustic" +
            " avoid letter advice cage above",
            "d71de856f81a8acc65e6fc851a38d4d7ec216fd0796d0a6827a3ad6ed5511a30fa280f12eb2e47ed2ac03b5c462a0358d18d69fe4f985ec81778c1b370b652a8",


            "ffffffffffffffffffffffffffffffff", "zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo zoo " +
            "wrong",
            "ac27495480225222079d7be181583751e86f571027b0497b5b5d11218e0a8a13332572917f0f8e5a589620c6f15b11c61dee327651a14c34e18231052e48c069",


            "000000000000000000000000000000000000000000000000", "abandon abandon abandon abandon " +
            "abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon " +
            "abandon abandon abandon agent",
            "035895f2f481b1b0f01fcf8c289c794660b289981a78f8106447707fdd9666ca06da5a9a565181599b79f53b844d8a71dd9f439c52a3d7b3e8a79c906ac845fa",


            "7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f7f", "legal winner thank year wave " +
            "sausage worth useful legal winner thank year wave sausage worth useful legal will",
            "f2b94508732bcbacbcc020faefecfc89feafa6649a5491b8c952cede496c214a0c7b3c392d168748f2d4a612bada0753b52a1c7ac53c1e93abd5c6320b9e95dd",


            "808080808080808080808080808080808080808080808080", "letter advice cage absurd amount" +
            " doctor acoustic avoid letter advice cage absurd amount doctor acoustic avoid letter" +
            " always",
            "107d7c02a5aa6f38c58083ff74f04c607c2d2c0ecc55501dadd72d025b751bc27fe913ffb796f841c49b1d33b610cf0e91d3aa239027f5e99fe4ce9e5088cd65",


            "ffffffffffffffffffffffffffffffffffffffffffffffff", "zoo zoo zoo zoo zoo zoo zoo zoo " +
            "zoo zoo zoo zoo zoo zoo zoo zoo zoo when",
            ...
            "77c2b00716cec7213839159e404db50d", "jelly better achieve collect unaware mountain " +
            "thought cargo oxygen act hood bridge",
            "b5b6d0127db1a9d2226af0c3346031d77af31e918dba64287a1b44b8ebf63cdd52676f672a290aae502472cf2d602c051f3e6f18055e84e4c43897fc4e51a6ff",


            "b63a9c59a6e641f288ebc103017f1da9f8290b3da6bdef7b", "renew stay biology evidence goat" +
            " welcome casual join adapt armor shuffle fault little machine walk stumble urge " +
            "swap",
            ...
            "dignity pass list indicate nasty swamp pool script soccer toe leaf photo multiply " +
                    "desk host tomato cradle drill spread actor shine dismiss champion exotic",
            ...
            "0460ef47585604c5660618db2e6a7e7f", "afford alter spike radar gate glance object seek" +
            " swamp infant panel yellow",
            ...
            "72f60ebac5dd8add8d2a25a797102c3ce21bc029c200076f", "indicate race push merry suffer " +
            "human cruise dwarf pole review arch keep canvas theme poem divorce alter left",
            ...
            "clutch control vehicle tonight unusual clog visa ice plunge glimpse recipe series " +
                    "open hour vintage deposit universe tip job dress radar refuse motion taste",
            ...
            "eaebabb2383351fd31d703840b32e9e2", "turtle front uncle idea crush write shrug there " +
            "lottery flower risk shell",
            "bdfb76a0759f301b0b899a1e3985227e53b3f51e67e3f2a65363caedf3e32fde42a66c404f18d7b05818c95ef3ca1e5146646856c461c073169467511680876c",


            "7ac45cfe7722ee6c7ba84fbc2d5bd61b45cb2fe5eb65aa78", "kiss carry display unusual " +
            "confirm curtain upgrade antique rotate hello void custom frequent obey nut hole " +
            "price segment",
            ...
            "exile ask congress lamp submit jacket era scheme attend cousin alcohol catch course " +
                    "end lucky hurt sentence oven short ball bird grab wing top",
            ...
            "18ab19a9f54a9274f03e5209a2ac8a91", "board flee heavy tunnel powder denial science " +
            "ski answer betray cargo cat",
            ...
            "18a2e1d81b8ecfb2a333adcb0c17a5b9eb76cc5d05db91a4", "board blade invite damage undo " +
            "sun mimic interest slam gaze truly inherit resist great inject rocket museum chief",
    ...
    public void testVectors() throws Exception {
        for (int ii = 0;
            ...
            List<String> code = mc.toMnemonic(Utils.hexStringToByteArray(vecData));
    ...
    public void testBadWord() throws Exception {
        List<String> words = split("risk tiger venture dinner xyzzy assume float denial penalty " +
                "hello game wing");
        mc.check(words);
    }
    ...
    public void testBadChecksum() throws Exception {
        List<String> words = split("bless cloud wheel regular tiny venue bird web grief security " +
                "dignity zoo");
        mc.check(words);
    }
