...
//            "103.84.87.82",         // Matt Corallo
            "seed.mcgventure.cn",         // Matt Corallo
//            "api.primecoin.org",         // Matt Corallo
//            "seed.ppcoin.net",         // Matt Corallo
//            "xpm.altcointech.net",       // Chris Decker
//            "dnsseed.xpm.altcointech.net",
//            "xpm2.altcointech.net",
...
//    public static final int MaxPeerConnections = 6;
    public static final int MaxPeerConnections = 1;
    public static final int MaxPeerBackgroundConnections = 1;
//    public static final int MaxPeerBackgroundConnections = 2;
    ...
    public enum TransactionFeeMode {
        Normal(1000000), Low(100000), High(2000000), Higher(5000000), Times10(10000000);
