...
//        SQLiteDatabase db = mDb.getWritableDatabase();
    ...
    public List<AddressTx> insertOut(IDb db, Tx txItem) {
        ...
        String queryHDAddressSql = "select hd_account_id,path_type,address_index from hd_addresses where address=?";
        String updateHDAddressIssuedSql = "update hd_addresses set is_issued=? where path_type=? and address_index=? and hd_account_id=?";
        String queryHDAccountAddressSql = "select hd_account_id,path_type,address_index from hd_account_addresses where address=?";
