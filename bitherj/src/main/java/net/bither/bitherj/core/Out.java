...
//        checkArgument(value.compareTo(PrimerjSettings.MAX_MONEY) < 0, "Values larger than
...
//    }
    ...
    public Out(Tx parent, long value, byte[] scriptBytes) {
        ...
        checkArgument(value < PrimerjSettings.MAX_MONEY, "Values larger than MAX_MONEY not " +
                "allowed");
        this.outValue = value;
        this.outScript = scriptBytes;
        this.tx = parent;
