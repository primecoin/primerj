...
public class Tx extends Message implements Comparable<Tx> {
     ...
     */
    public static final long MIN_NONDUST_OUTPUT = Utils.CENT; //5460
    public static final long MIN_CHANGE_OUTPUT = 25 * Utils.CENT;
...
//    public int length;
    ...
    public boolean isMature() {
        ...
        return BlockChain.getInstance().lastBlock.getBlockNo() - blockNo + 1 >= PrimerjSettings
    ...
    /**
     * Same as {@link #addSignedInput(Out, net.bither.bitherj.script.Script, net.bither.bitherj.crypto.ECKey, net.bither.bitherj.crypto.TransactionSignature.SigHash, boolean)}
...
//            cannot be statically proven
    ...
    public synchronized byte[] hashForSignatureForBCD(int inputIndex, byte[] connectedScript,
                                                      TransactionSignature.SigHash type,boolean anyoneCanPay) {
        // The SIGHASH flags are used in the design of contracts, please see this page for a
        // further understanding of
        // the purposes of the code in this method:
        //
    ...
    public void verify() throws VerificationException {
        ...
        if (valueOut > PrimerjSettings.MAX_MONEY) {
